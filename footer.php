...
<footer id="colophon" class="site-footer" role="contentinfo">
    <div class="mx-auto px-4" style="max-width: 960px;">
        <div class="flex justify-between gap-12 py-12">
            <!-- Coluna Esquerda: Menu + Redes Sociais -->
            <div class="flex-1">
                <nav class="footer-nav" role="navigation" aria-label="Menu do rodapé">
                    <?php
                    wp_nav_menu(array(
                ...
                <!-- Redes Sociais -->
                <div class="social-links flex gap-4 items-center mt-8">
            ...
            <!-- Coluna Direita: Busca + Widget + Créditos -->
            <div class="flex-1">
                <!-- Formulário de Busca -->
                ...
                <!-- Créditos -->
                <div class="footer-credits mt-8 text-sm" style="color: var(--rakan-text-muted);">
                    <p class="m-0">
                        Desenvolvido por 
                        <a href="https://hyaon.com" target="_blank" rel="noopener noreferrer" class="hyaon-link no-underline font-semibold transition-opacity duration-200">
                            Hyaon
                        </a>
                    </p>
                </div>
